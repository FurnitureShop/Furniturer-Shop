        ...
        >
                ...
                <Col span={20}>
                    <Form.Item
                        ...
                        shouldUpdate={(prevValues, curValues) =>
                            curValues.oldPassword.length === 0 || curValues.oldPassword.length === 1
                        }>
                        <FloatLabel label="Old password" value={form.getFieldValue("oldPassword")}>
                            <Input type="password" size="large" onChange={e => onOldPasswordChangeHandler(e.target.value)} />
                        </FloatLabel>
                    </Form.Item>
                </Col>
            </Row>
            <Row className="mb-2">
                <Col span={20}>
                    <Form.Item
                        ...
                        shouldUpdate={(prevValues, curValues) =>
                            curValues.newPassword.length === 0 || curValues.newPassword.length === 1
                        }>
                        <FloatLabel label="New password" value={form.getFieldValue("newPassword")}>
                            <Input type="password" size="large" onChange={e => onNewPasswordChangeHandler(e.target.value)} />
                        </FloatLabel>
                    </Form.Item>
                </Col>
            </Row>
            <Row>
                <Col span={20}>
                    ...
                    >
                        <FloatLabel label="Confirm new password" value={form.getFieldValue("confirmPassword")}>
            ...
            <Row>
                <Form.Item>
                    <Button className="w-44" size="large" type="primary" htmlType="submit" loading={isLoading}>
                        <span style={{ font: "italic 16px EB Garamond" }}>Update password</span>
                    </Button>
                </Form.Item>
            </Row>
        </Form>
